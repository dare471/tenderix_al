...
$POST_RIGHT = $APPLICATION->GetGroupRight("pweb.tenderix");
if($POST_RIGHT=="D")
	$APPLICATION->AuthForm(GetMessage("ACCESS_DENIED"));

if(isset($_REQUEST["LOT_ID"])) {
	$rsFile = CTenderixProposal::GetFileListPropertyLot($LOT_ID, $PROPERTY, $FILE_ID);
} elseif(isset($_REQUEST["PROPOSAL_ID"])) {
	$rsFile = CTenderixProposal::GetFileListProperty($PROPOSAL_ID, $PROPERTY, $FILE_ID);
}
