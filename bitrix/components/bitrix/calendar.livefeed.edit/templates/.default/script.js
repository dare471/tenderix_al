;(function(window){
	...
	window.EditEventManager.prototype = {
		...
		CheckPlannerState: function(timeout)
		{
			...
			{
				var params = {}, fromDate = this.ParseDate(BX.util.trim(this.pFromDate.value)), toDate = this.ParseDate(BX.util.trim(this.pToDate.value)), arInputs = BX('feed-event-dest-cont', true).getElementsByTagName('INPUT'), i, arCodes = [];
