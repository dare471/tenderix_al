...
$date_tek = time();
$dis_arch = "";
if ((($arResult["LOT"]["ACTIVE"] == "Y") && ($arResult["LOT"]["NOEDIT"] == "Y") && ($arResult["COPY"] == "N") && ($date_tek > $date_end) && ($date_end != 0)) || (($arResult["LOT"]["ACTIVE"] == "Y") && ($arResult["COPY"] == "N") && ($date_tek < $date_end) && ($date_tek > $date_start) && ($date_end != 0) && ($date_start != 0))) {?>
    <br />
    <br />
    <div class="well">
    <h4 style="color:red">Редактирование запрещено.</h4>
    </div>
    <?
    $dis_arch = " disabled";
} else {?>
...
<div class="lot-add">
    ...
    <form name="lotadd_form" action="<?= POST_FORM_ACTION_URI ?>" method="post" enctype="multipart/form-data">
        ...
        <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <tr>
                    ...
                    <td width="60%" class="right-col">
                        <div class="form-group">
                            <select class="form-control input-sm" onchange="if(this[this.selectedIndex].value!='') window.location=this[this.selectedIndex].value;" <?= (defined('BX_PUBLIC_MODE') && BX_PUBLIC_MODE == 1 ? "disabled=\"disabled\"" : "") ?> <?= $dis_arch; ?>>
            ...
            <tr>
                <td width="40%" class="left-col">
                    <?= GetMessage("PW_TD_RESPONSIBLE_PHONE") ?>:
                </td>
                <td width="60%" class="right-col">
                    <div class="form-group">
                ...
                <? foreach ($arResult["LOT"]["SPEC"] as $kkey => $PROP): ?>
                    <? if (is_numeric($kkey)) { ?>
                        <tr>
                            ...
                            <td align="center" width="20">
                                <div class="form-group">
                                    <input class="form-control input-sm" type="text" name="PROP_<?= $PROP["PROP_ID"] ?>_COUNT" value="<?= $PROP["COUNT"] ?>" style="width: 98%" <?= $dis_arch; ?> />
                                </div>
                            </td>
                            <td align="center" width="50">
                                <div class="form-group">
                                    <input class="form-control input-sm" type="text" name="PROP_<?= $PROP["PROP_ID"] ?>_START_PRICE" value="<?= $PROP["START_PRICE"] ?>" style="width: 98%" <?= $dis_arch; ?> />
                                </div>
                            </td>
                            <td align="center" width="50">
                                <div class="form-group">
