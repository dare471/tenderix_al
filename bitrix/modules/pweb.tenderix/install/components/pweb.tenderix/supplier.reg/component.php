...
$rsUserInfo = CTenderixUserSupplier::GetList($by = "", $order = "", array("ID" => $ID));
...
$arParams["DOP_FIELDS_STATEREG_ACTIVE"] = array_intersect(array("STATEREG_PLACE", "STATEREG_DATE", "STATEREG_OGRN"), $arParams["FIELDS"]) ? "Y" : "N";
